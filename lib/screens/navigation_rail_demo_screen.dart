...
class NavigationRailDemoScreen extends StatefulWidget {
  const NavigationRailDemoScreen({Key? key}) : super(key: key);

  @override
  State<NavigationRailDemoScreen> createState() => _NavigationRailDemoScreenState();
}

class _NavigationRailDemoScreenState extends State<NavigationRailDemoScreen> {
